...
from src.utils.constants import STATS_COLUMNS

from src.step2_summarize import (
    read_csv_data,
    validate_years,
    clean_data,
    align_team_name,
...
def test_draw_plots_success(valid_data, tmp_path):
    ...
    with patch('matplotlib.pyplot.figure') as mock_figure, \
        ...
        assert mock_savefig.call_count == len(STATS_COLUMNS)  # Using length of STATS_COLUMNS
